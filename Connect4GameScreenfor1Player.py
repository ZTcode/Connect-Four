...
#_____________________________GamePlay____________________________________
    ...
    computer = PlayerRed or PlayerBlue 
    ...
    for n in range(42):
        print(currentColor, human, computer)
        if currentColor == human:
            totalCount = sum(counts)
            while totalCount == sum(counts):
                move = win.getMouse()
                firstPick.undraw()
                if 115 <= move.getX() <= 145 and 175 <= move.getY() <= 425:
                    if counts[0] == 0:
                        cir36.setFill(human)
                        cir36.color = human
                        counts[0] +=1
                ...
                elif 155 <= move.getX() <= 185 and 175 <= move.getY() <= 425:
                    if counts[1] == 0:
                        cir37.setFill(human)
                        counts[1] +=1
                        cir37.color = human
                ...
                elif 195 <= move.getX() <= 225 and 175 <= move.getY() <= 425:
                    if counts[2] == 0:
                        cir38.setFill(human)
                        counts[2] +=1
                        cir38.color = human
                ...
                elif 235 <= move.getX() <= 265 and 175 <= move.getY() <= 425:
                    if counts[3] == 0:
                        cir39.setFill(human)
                        counts[3] +=1
                        cir39.color = human 
                ...
                elif 275 <= move.getX() <= 305 and 175 <= move.getY() <= 425:
                    if counts[4] == 0:
                        cir40.setFill(human)
                        counts[4] +=1
                        cir40.color = human 
                ...
                elif 315 <= move.getX() <= 345 and 175 <= move.getY() <= 425:
                    if counts[5] == 0:
                        cir41.setFill(human)
                        counts[5] +=1
                        cir41.color = human 
                ...
                elif 355 <= move.getX() <= 385 and 175 <= move.getY() <= 425:
                    if counts[6] == 0:
                        cir42.setFill(human)
                        counts[6] +=1
                        cir42.color = human 
            ...
            if i<0:
                ...
                if counts[0] == 0:
                    cir36.setFill(computer)
                    cir36.color = computer
                    counts[0] +=1
                elif counts[0]==1:
                    cir29.setFill(computer)
                    counts[0] += 1
                    cir29.color = computer 
                elif counts[0]==2:
                    cir22.setFill(computer)
                    counts[0]+= 1
                    cir22.color = computer 
                elif counts[0]==3:
                    cir15.setFill(computer)
                    counts[0]+=1
                    cir15.computer = color 
                elif counts[0]==4:
                    cir8.setFill(computer)
                    counts[0]+=1
                    cir8.color = computer 
                elif counts[0]==5:
                    cir1.setFill(computer)
                    counts[0]+=1
                    cir1.color = computer
                ...
                if counts[1] == 0:
                    cir37.setFill(computer)
                    counts[1] +=1
                    cir37.color = computer 
                elif counts[1]==1:
                    cir30.setFill(computer)
                    counts[1] += 1
                    cir30.color = computer 
                elif counts[1]==2:
                    cir23.setFill(computer)
                    counts[1]+= 1
                    cir23.color = computer 
                elif counts[1]==3:
                    cir16.setFill(computer)
                    counts[1]+=1
                    cir16.color = computer
                elif counts[1]==4:
                    cir9.setFill(computer)
                    counts[1]+=1
                    cir9.color = computer 
                elif counts[1]==5:
                    cir2.setFill(computer)
                    counts[1]+=1
                    cir2.color = computer 
                ...
                if counts[2] == 0:
                    cir38.setFill(computer)
                    counts[2] +=1
                    cir38.color = computer
                elif counts[2]==1:
                    cir31.setFill(computer)
                    counts[2] += 1
                    cir31.color =computer
                elif counts[2]==2:
                    cir24.setFill(computer)
                    counts[2]+= 1
                    cir24.color = computer 
                elif counts[2]==3:
                    cir17.setFill(computer)
                    counts[2]+=1
                    cir17.color = computer 
                elif counts[2]==4:
                    cir10.setFill(computer)
                    counts[2]+=1
                    cir10.color = computer 
                elif counts[2]==5:
                    cir3.setFill(computer)
                    counts[2]+=1
                    cir3.color = computer 
                ...
                if counts[3] == 0:
                    cir39.setFill(computer)
                    counts[3] +=1
                    cir39.color = computer
                elif counts[3]==1:
                    cir32.setFill(computer)
                    counts[3] += 1
                    cir32.color = computer 
                elif counts[3]==2:
                    cir25.setFill(computer)
                    counts[3]+= 1
                    cir25.color = computer 
                elif counts[3]==3:
                    cir18.setFill(computer)
                    counts[3]+=1
                    cir18.color =computer 
                elif counts[3]==4:
                    cir11.setFill(computer)
                    counts[3]+=1
                    cir11.color = computer 
                elif counts[3]==5:
                    cir4.setFill(computer)
                    counts[3]+=1
                    cir4.color = computer 
                ...
                if counts[4] == 0:
                    cir40.setFill(computer)
                    counts[4] +=1
                    cir40.color = computer
                elif counts[4]==1:
                    cir33.setFill(computer)
                    counts[4] += 1
                    cir33.color = computer
                elif counts[4]==2:
                    cir26.setFill(computer)
                    counts[4]+= 1
                    cir26.color = computer 
                elif counts[4]==3:
                    cir19.setFill(computer)
                    counts[4]+=1
                    cir19.color = computer 
                elif counts[4]==4:
                    cir12.setFill(computer)
                    counts[4]+=1
                    cir12.color = computer 
                elif counts[4]==5:
                    cir5.setFill(computer)
                    counts[4]+=1
                    cir5.color = computer 
                ...
                if counts[5] == 0:
                    cir41.setFill(computer)
                    counts[5] +=1
                    cir41.color = computer
                elif counts[5]==1:
                    cir34.setFill(computer)
                    counts[5] += 1
                    cir34.color = computer
                elif counts[5]==2:
                    cir27.setFill(computer)
                    counts[5]+= 1
                    cir27.color = computer 
                elif counts[5]==3:
                    cir20.setFill(computer)
                    counts[5]+=1
                    cir20.color = computer 
                elif counts[5]==4:
                    cir13.setFill(computer)
                    counts[5]+=1
                    cir13.color = computer 
                elif counts[5]==5:
                    cir6.setFill(computer)
                    counts[5]+=1
                    cir6.color = computer
                ...
                if counts[6] == 0:
                    cir42.setFill(computer)
                    counts[6] +=1
                    cir42.color = computer 
                elif counts[6]==1:
                    cir35.setFill(computer)
                    counts[6] += 1
                    cir35.color = computer 
                elif counts[6]==2:
                    cir28.setFill(computer)
                    counts[6]+= 1
                    cir28.color = computer
                elif counts[6]==3:
                    cir21.setFill(computer)
                    counts[6]+=1
                    cir21.color = computer 
                elif counts[6]==4:
                    cir14.setFill(computer)
                    counts[6]+=1
                    cir14.color = computer 
                elif counts[6]==5:
                    cir7.setFill(computer)
                    counts[6]+=1
                    cir7.color = computer 
